...
public class DeploymentResource extends ResourceConfig implements DeploymentService, ManagementService {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(code = 500, message = "Error handling request")})
    @Override
    public String createEc2Cluster(String deploymentId, Ec2ClusterDescriptor ec2Cluster) throws Exception {
        return DeploymentServiceProvider.get().createEc2Cluster(deploymentId, ec2Cluster);
    }
